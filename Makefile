...
#
OBJS = server.o request.o segel.o client.o Thread.o Queue.o
TARGET = server
...
server: server.o request.o segel.o Thread.o Queue.o
	$(CC) $(CFLAGS) -o server server.o request.o segel.o Queue.o Thread.o $(LIBS)
